...
public class AccessibilityManager {
    ...
    private let scene: InternalScene
    ...
    public init(scene: InternalScene) {
        self.scene = scene
...
//        }
    ...
    private func update() {
        ...
        for paddle in scene.graphicsInfo(forName: "paddle") {
            paddle.xScale = CGFloat(paddleSize)
        }
    ...
    private func handleBallCollision(ball: InternalGraphic, other: InternalGraphic) {
...
//        }
    ...
    private var activeBricks: [InternalGraphic] {
        return scene.graphicsInfo(forName: "brick").filter({ $0.parent != nil })
    }
